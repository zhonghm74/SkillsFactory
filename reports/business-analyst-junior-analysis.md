...
![Growth Driver Breakdown](assets/growth-driver-breakdown-indexed.png)

| 增长驱动指标 | 2019 | 2020 | 同比 | 结论 |
|---|---:|---:|---:|---|
| 客户数 | 21 | 21 | 0.00% | 客户盘子未扩张 |
| 订单数 | 68 | 221 | 225.00% | 交易频次显著提升 |
| 每客户订单数 | 3.24 | 10.52 | 225.00% | 增长核心驱动 |
| 平均每客户产品覆盖数（去重） | 12.81 | 24.14 | 88.48% | 客户可购组合更丰富 |
| 平均每客户活跃月数 | 2.90 | 6.67 | 129.51% | 客户活跃深度提升 |
| 客户-产品组合数（去重） | 269 | 507 | 88.48% | 交叉销售深度提升 |

**Data-backed Annotation:** 客户数保持不变（21→21），但每客户订单数 **+225.00%**、平均每客户产品覆盖数 **+88.48%**、平均每客户活跃月数 **+129.51%**，因此增长主要来自频次提升和产品覆盖扩展，而非客户数扩张。
